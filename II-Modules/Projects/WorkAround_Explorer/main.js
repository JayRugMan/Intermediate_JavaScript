...
import { makeMoney } from "./modules/utilities.js";
...
function updateResults(){
  ...
  document.getElementById('salarySelected').innerText = `The salary for ${role}s at ${company} is ${makeMoney(salary)}`;
  document.getElementById('salaryAverageByRole').innerText = `The industry average salary for ${role} positions is ${makeMoney(averageSalaryByRole)}`;
  document.getElementById('salaryAverageByCompany').innerText = `The average salary at ${company} is ${makeMoney(averageSalaryByCompany)}`;
  document.getElementById('salaryAverageIndustry').innerText = `The average salary in the Tech industry is ${makeMoney(industryAverageSalary)}`;
}
